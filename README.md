...
I was able to achieve over 28% accuracy on a training set of 5000 games. The model isn't learning the way that I want it to, so I'll have to try looking at changing which layers I'm using.
